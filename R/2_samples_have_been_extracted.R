# This is a script for adding samples that are not in the database and have not been extracted yet

# enter the interval of sample numbers to be extracted, species, and 2-digit year
span <- 95:188
species <- "TEST"
year <- "16"

# make a list of sample IDs in the order they are going to be extracted
sampID <- paste(species, year, "_", formatC(span, width = 3, format = "d", flag = "0"), sep = "")
