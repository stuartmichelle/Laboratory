...
# enter the file containing list of lab ids
list <- read.csv("data/L2979-L3074list.csv", stringsAsFactors = F, row.names = 1)
list$sample <- NA 
...
write.csv(list, file = "data/L2979-L3074list.csv", row.names = F)
